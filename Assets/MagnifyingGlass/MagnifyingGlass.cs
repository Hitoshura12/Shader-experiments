...
public class MagnifyingGlass : MonoBehaviour
{
    ...
    float zoomOrthoAspectAdjusted;// zoom adjusetd to orthographic size and screen aspect ratio
    ...
    void Calcualte()
    {
        ...
        zoomOrthoAspectAdjusted = (halfZoom / cam.orthographicSize) / screenAspect;
        ...
        xOffset = halfZoom + zoomOrthoAspectAdjusted * trans.position.x - zoomOrthoAspectAdjusted * cameraTrans.position.x;
